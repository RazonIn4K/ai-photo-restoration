...
class ContentAddressedStorage {
  ...
  retrieve(category: 'originals' | 'restored', sha256: string): Promise<RetrieveResult>;

  // Delete file (cryptographic erasure)
  delete(category: 'originals' | 'restored', sha256: string, eraseDEKOnly?: boolean): Promise<void>;

  // Check if file exists
  exists(category: 'originals' | 'restored', sha256: string): Promise<boolean>;
